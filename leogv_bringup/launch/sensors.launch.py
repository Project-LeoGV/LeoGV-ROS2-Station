...
def generate_launch_description():
    laser_sensor_name = os.getenv('leogv_LASER_SENSOR', '')
    depth_sensor_name = os.getenv('leogv_DEPTH_SENSOR', '')
    
    fake_laser_config_path = PathJoinSubstitution(
        [FindPackageShare('leogv_bringup'), 'config', 'fake_laser.yaml']
    )
    ...
    laser_launch_path = PathJoinSubstitution(
        [FindPackageShare('leogv_bringup'), 'launch', 'lasers.launch.py']
    )

    depth_launch_path = PathJoinSubstitution(
        [FindPackageShare('leogv_bringup'), 'launch', 'depth.launch.py']
    )
